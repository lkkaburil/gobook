...
<body>
 ...
 <ul class="nav nav-tabs" id="ser1">
  ...
  <div class="tab-content"> 
    <h2></h2> 
    <h2>Service</h2> 
    <form name = "frm" action="./reservation/reservation2" method="post"> 
  ...
  <tr><th height="100px">아니 왜</th></tr>
  <tr><th id="pic3"><center>
  <input type="button" name="select" value="선택" class="my_box"/>
  </center></th></tr>
  </table>
  </div>
  ...
  <tr><th id="pic2">글자가 이상하게 바뀌는거야 씨발</th></tr>
  ...
  <tr><th height="100px">아나 존나 어이없네 진짜 시발</th></tr>
  <tr><th id="pic3"><center><input type="button" name="select" value="선택" class="my_box"/></center></th></tr>

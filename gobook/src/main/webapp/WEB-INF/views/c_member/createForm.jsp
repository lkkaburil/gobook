...
<!--STYLESHEETS-->
<link href="${root}/css/c_member/style.css" rel="stylesheet" type="text/css" />
		...
		<table class="question">
			...
			<tr>
				...
				<td>
					...
					<button class="button" onclick="idCheck(document.frm.c_id.value)">ID 중복확인</button>
				</td>
			</tr>
			<tr>
			...
			<TR>
				...
				<TD>
					<input type="email" name="c_email" size="30" placeholder="예 : gobook@xxxxx.com"> <!--  타입이 email이면 submit 시에 @가 있는지 확인한다. -->
					<button type="button" class="button" onclick="emailCheck(document.frm.c_email.value)">e-mail 인증</button>
					<!-- 이메일 인증 버튼을 누르면 우선 중복확인을 한 뒤 인증 이메일이 보내진다. -->
				</TD>
			</TR>
			<TR>
				<TD>
					인증코드 &nbsp <input type="password" name="c_email_code" size="8" maxlength="4">

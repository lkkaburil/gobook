...
<form name="login-form" class="login-form" action="./login" method="post">
    ...
    <div class="content">
	<!--USERNAME-->
	<input name="c_id" type="text" class="input username" onfocus="this.value=''" value='${cc_id_val }'/>
		<c:choose>
			<c:when test="${cc_id == 'Y' }">
	...
	<!--END USERNAME-->
    <!--PASSWORD--><input name="c_passwd" type="password" class="input password" onfocus="this.value=''" /><!--END PASSWORD-->
    </div>
    <!--END CONTENT-->

								...
								<div class="grid-item">
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<div class="post">
												<div class="post__media"><a  href="javascript:read('${dto.re_num}')"><img src="${dto.re_filename }?w=1260&amp;h=750&amp;auto=compress&amp;cs=tinysrgb" alt=""/></a></div>
												<c:if test="${not empty dto.filename }">
					<a href="javascript:fileDown('${dto.filename }')">${dto.filename }</a>
					</c:if>&nbsp;
												<div class="post__body">
													<div class="post__meta"><span class="date">${dto.re_wdate }</span><span class="author"><a  href="javascript:read('${dto.re_num}')" rel="">by ${dto.s_id}${dto.c_id }님</a></span></div>

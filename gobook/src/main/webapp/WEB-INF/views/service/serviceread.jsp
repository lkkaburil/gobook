...
<h2>소비자 회원 예약 정보</h2>
 <TABLE id="infomation">
    ...
    <TR>
      <TH>서비스 내용</TH>
         <TD id='content'>여기에는 서비스 설명이 들어간다 내용이 많이 들어갈거야 ㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎㅎ
         ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㄴㄹㅇㄴㄹㄴㅇㄹㅑㄹ야ㅓㅇ랼야ㅑㅇㄹ</TD>
    </TR>
    <TR>	
      <TH>서비스가격</TH>
      <TD>zzzz</TD>
    ...
    <div class="bottom">
     <button type="button" onclick="serlist()">목록</button>
     <button type="button" onclick="serupdate()">수정</button>
     <button type="button" onclick="serdel()">삭제</button>
    </div>

...
<html>
	<head>
		...
		<link rel="stylesheet" href="${root }/resources/css/cjs/css/c_template/assets/css/main.css" />
	...
	<body>
		...
		<!-- Scripts -->
			<script src="${root }/resources/css/cjs/css/c_template/assets/js/jquery.min.js"></script>
			<script src="${root }/resources/css/cjs/css/c_template/assets/js/jquery.scrolly.min.js"></script>
			<script src="${root }/resources/css/cjs/css/c_template/assets/js/jquery.scrollzer.min.js"></script>
			<script src="${root }/resources/css/cjs/css/c_template/assets/js/skel.min.js"></script>
			<script src="${root }/resources/css/cjs/css/c_template/assets/js/util.js"></script>
			<!--[if lte IE 8]><script src="assets/js/ie/respond.min.js"></script><![endif]-->
			<script src="${root }/resources/css/cjs/css/c_template/assets/js/main.js"></script>
